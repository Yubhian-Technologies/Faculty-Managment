...
const KNOWN_KEYS = new Set([
  "highestQualification", "researchAreasInterests", "secondaryEducation", "intermediateDiplomaIti",
  "ugDetails", "additionalUgDetails", "pgDetails", "additionalPgDetails",
  "phdDetails", "additionalPhdDetails", "postdoctoralFellowshipDetails",
  "netSletSetGateOthers", "qualifiedExam", "pleaseSpecifyExam",
  "examScore", "qualifiedYear", "educationalQualifications",
  "teachingAssignment", "teachingRolesResponsibilities", "industryRolesResponsibilities", "researchRolesResponsibilities",
  "academicExperience", "industryExperience", "researchExperience",
  "promotionHistory",
