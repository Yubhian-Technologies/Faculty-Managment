...
// Published/Granted/Commercialized/Revenue-Generated proof - same pattern as
// /api/upload/consultancy-doc.
const KINDS = ["published-proof", "granted-proof", "commercialized-proof", "revenue-proof"] as const;
...
export async function POST(request: Request) {
  try {
    ...
    const path = `ipr-docs/${session.collegeId}/${session.uid}/${kind}/${randomUUID()}.${ext}`;
    ...
    console.error("[upload/ipr-doc POST]", err);
