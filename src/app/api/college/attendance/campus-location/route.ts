...
// Read-only: lets faculty/HOD/Principal see the geofence they need to be
// inside before attempting check-in, without exposing the rest of the
// college record (name, contact details, etc.) that GET /api/admin/colleges
