...
export default function ManagementCollegeDetailPage() {
  ...
  const cards = [
    ...
    { label: "Vice Principal", icon: UserCog, href: `/management/faculty/${collegeId}/vice-principal` },
    { label: "Departments", icon: Users2, href: `/management/faculty/${collegeId}/departments` },
  ];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button variant="outline" onClick={() => router.push("/management/faculty")}>
