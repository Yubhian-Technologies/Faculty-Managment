...
// `closed` mirrors isHiringClosed()'s single-candidate case (hiringPipeline.ts) -
// true only once the faculty account's credentials have actually been created,
// not merely once the offer/decision stage is done.
  ...
  function loadCandidates() {
    ...
    Promise.all([
      ...
      .then(([appsRes, candsRes, offersRes, accountRequestsRes]) => {
        ...
        // across the rest of the Office hiring pipeline.
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          scope === "active"
            ? "Principal-approved candidates that have been sent to Accounts for offer letters"
