...
export default function EditLeaveProfilePage() {
  ...
  return (
    <div className="max-w-lg space-y-6">
      <PageHeader title="Edit Leave Profile" description="Override category defaults for this employee" />
      <Card>
        <CardContent className="p-4 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              The category this employee converts into once past the college&apos;s new-joining threshold.
            </p>
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            <Button variant="outline" onClick={() => router.push("/hod/leave/profiles")}>
              Cancel
            </Button>
