...
export default function HodSupportingStaffViewPage() {
  ...
  return (
    <SupportingStaffProfileHub
      staff={staff}
      basePath={`/hod/supporting-staff/${staffId}`}
      backHref="/hod/supporting-staff"
      editHref={`/hod/supporting-staff/${staffId}/edit`}
    />
  );
}
