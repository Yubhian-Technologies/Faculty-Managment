...
export default function HodSupportingStaffModuleEditPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      router.push(`/hod/supporting-staff/${staffId}/${moduleKey}`);
    } catch {
        ...
        <Card>
          <CardContent className="pt-6 space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              <Button variant="outline" onClick={() => router.push(`/hod/supporting-staff/${staffId}/${moduleKey}`)}>Cancel</Button>
