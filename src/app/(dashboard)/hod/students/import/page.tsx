  ...
  return (
    <div className="max-w-5xl space-y-6">
      <PageHeader
        ...
        description="Bulk upload the student roster from a CSV/Excel file"
        actions={
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Download the template, fill in your student roster, and upload it below.
          </p>
          ...
          <CardContent className="p-5 space-y-4">
            ...
            {result.created > 0 && (
              <Button asChild variant="outline" size="sm">
                <Link href="/hod/sections">Back to Sections</Link>
              </Button>
            )}
          </CardContent>
        </Card>
