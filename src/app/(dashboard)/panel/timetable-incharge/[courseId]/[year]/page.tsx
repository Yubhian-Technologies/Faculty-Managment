...
// same shape as the HOD's own (hod/timetable/[courseId]/[year]/page.tsx),
// minus the Incharge-assignment card itself (only the HOD manages that).
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button variant="outline" onClick={() => router.push("/panel/timetable-incharge")}>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {sections.map((s) => (
            <Card
              ...
              onClick={() => router.push(`/panel/timetable-incharge/${courseId}/${year}/${s.id}`)}
            >
