...
export default function PrincipalNonTechnicalStaffModulePage() {
        ...
        actions={
          <div className="flex gap-2">
            <Button variant="outline" asChild>
              <Link href={`/principal/staff/non-technical/${staffId}`}><ArrowLeft className="h-4 w-4 mr-2" />Back</Link>
            </Button>
            <Button asChild>
              <Link href={`/principal/staff/non-technical/${staffId}/${moduleKey}/edit`}><Pencil className="h-4 w-4 mr-2" />Edit</Link>
            </Button>
          </div>
        }
      />
