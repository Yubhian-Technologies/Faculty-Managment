...
import { CheckCircle, XCircle, CalendarDays, User, BookOpen, ChevronDown, ChevronUp } from "lucide-react";
...
const PENDING_PRINCIPAL_STATUSES = new Set(["PENDING_RATIFICATION", "PENDING_MANAGEMENT"]);
...
export default function PrincipalLeavePage() {
  ...
  const load = useCallback(() => {
    ...
    fetch("/api/leave/applications")
      ...
      .then((d) => setRequests((d.requests ?? []).filter((r) => PENDING_PRINCIPAL_STATUSES.has(r.status))))
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Review and approve leave applications awaiting your sign-off"
      />
        ...
        <CardContent className="space-y-4">
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Applications awaiting your approval will appear here."
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant="outline" className="text-xs bg-yellow-50 text-yellow-700 border-yellow-200">
                            Pending {req.isOtherRequest && !req.leaveTypeCode ? "Principal" : "Ratification"}
                          </Badge>
                          {isExpanded
