...
// colleges have the full administrative structure (Academics system, IQAC, T&P,
...
const ALL_OFFICE_ROLES: UserRole[] = [
  "ACADEMICS", "IQAC_COORDINATOR", "T_AND_P", "R_AND_D", "PLACEMENT_DEPT", "LIBRARY", "EXAM_CELL", "WEBMASTER",
];
