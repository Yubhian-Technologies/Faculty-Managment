...
export const IMPORT_COLUMNS: FacultyCsvColumn[] = [
  ...
  { key: "name",         label: "Full Name",     required: true,  sample: "Required; full name", aliases: ["Faculty Name", "Name", "Employee Name"] },
  ...
  { key: "employmentType", label: "Employment Type", required: true, sample: "Required: Permanent / Contract / Visiting / Part-Time", aliases: ["Employment", "Type of Employment"] },
  ...
  { key: "dateOfJoiningDepartment", label: "Date of Joining Department (YYYY-MM-DD)", required: false, sample: "Optional; YYYY-MM-DD", aliases: ["Department Joining Date"] },

  // ─── Personal / statutory details (all optional) ──────────────────────────────
  { key: "gender",            label: "Gender",                       required: false, sample: "Optional: Male / Female / Other" },
  { key: "dateOfBirth",       label: "Date of Birth (YYYY-MM-DD)",   required: false, sample: "Optional; YYYY-MM-DD", aliases: ["DOB"] },
