...
export const NAV_ITEMS: NavItem[] = [
  ...
  // Commented out for this launch — only Hiring Pipeline, Academic Management,
  // and My Profile are live for Principal/Vice Principal. Uncomment to restore.
  ...
  // HOD
  // Commented out for this launch — only Hiring, Department, and My Profile
  // are live for HOD. Uncomment to restore.
  ...
  // Commented out for this launch — only Hiring (My Interviews, injected), My
  // Work, and My Profile are live for Faculty. Uncomment to restore.
