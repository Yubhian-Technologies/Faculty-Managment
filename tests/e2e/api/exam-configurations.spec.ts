...
test.describe("Exam Configurations API", () => {
  ...
  test("GET /api/college/exam-configurations returns configurations", async () => {
    test.skip(!env, "missing env vars");
    const res = await ctx.get("/api/college/exam-configurations");
